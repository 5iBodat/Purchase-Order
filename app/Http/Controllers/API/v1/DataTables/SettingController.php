...
use App\Http\Resources\API\v1\DataTables\SettingResource;
...
class SettingController extends Controller
{
    ...
    {
        $settings = Setting::select('id', 'key', 'remarks', 'value', 'created_at');
        ...
        return datatables()->of($settings)
            ...
            ->addColumn('action', 'settings.datatables.action')
            ->toJson();
    }
