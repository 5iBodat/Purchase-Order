...
<html lang="en">
    ...
    <body>
        <table>
            <tr>
                <td style="width: 10%; border: none">
                    <img
                        src="<?php echo e(public_path('static/images/logo/logo.png')); ?>"
                        alt="Pertamina Logo"
                        class="logo-1"
                    />
                </td>
                ...
                <?php if($poTransport->type == "MMTEI"): ?>
                <td style="width: 10%; border: none">
                    <img
                        src="<?php echo e(public_path('static/images/logo/pertamina.png')); ?>"
                        alt="Pertamina Logo"
                        class="logo-2"
                    />
                </td>
        ...
        <table>
            <tr style="text-align: center">
                ...
                <table class="table-no-border">
                    <tr>
                        <td>To :</td>
                        <td><?php echo e($poTransport->to); ?></td>
                        <td></td>
                        <td></td>
                        <td>PO. No :</td>
                        <td><?php echo e($poTransport->po_number); ?></td>
                    </tr>
                    <tr>
                        <td>Name :</td>
                        <td><?php echo e($poTransport->name); ?></td>
                        <td></td>
                        <td></td>
                        <td>PO. Date :</td>
                        <td><?php echo e($poTransport->po_date); ?></td>
                    </tr>
                    <tr>
                        <td>Address :</td>
                        <td><?php echo e($poTransport->address); ?></td>
                        <td></td>
                        <td></td>
                        <td>Delivery To :</td>
                        <td><?php echo e($poTransport->delivered_to); ?></td>
                    </tr>
                    <tr>
                        <td>Phone/fax :</td>
                        <td><?php echo e($poTransport->phone_fax); ?></td>
                        <td></td>
                        <td></td>
                        <td>Loading Point :</td>
                        <td><?php echo e($poTransport->loading_point); ?></td>
                    </tr>
                </table>
            </div>

        <p>Comments or special instructions : <?php echo e($poTransport->comments); ?></p>
        ...
        <table>
            ...
            <tbody>
                <tr class="">
                    ...
                    <td><?php echo e($poTransport->shipped_via); ?></td>
                    <td><?php echo e($poTransport->fob_point); ?></td>
                    <td><?php echo e($poTransport->term); ?> day</td>
                    <td>Rp. <?php echo e($poTransport->transport); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            ...
            <tr class="red-bg">
                <td><?php echo e($poTransport->quantity); ?></td>
                <td colspan="2"><?php echo e($poTransport->description); ?></td>
                <td>Rp. <?php echo e($poTransport->unit_price); ?></td>
                <td>Rp. <?php echo e($poTransport->amount); ?></td>
            </tr>
            <tr>
                <td colspan="3" style="border: none"></td>
                <td style="border: none; font-weight: bold; text-align:right">SUBTOTAL</td>
                <td>Rp. <?php echo e($poTransport->sub_total); ?></td>
            </tr>
            <tr>
                <td colspan="3" style="border: none"></td>
                <td style="border: none; font-weight: bold; text-align:right">Uang Portal</td>
                <td>Rp. <?php echo e($poTransport->portal_money); ?></td>
            </tr>
            <tr>
                <td colspan="3" style="border: none"></td>
                <td style="border: none; font-weight: bold; text-align:right">Total</td>
                <td>Rp. <?php echo e($poTransport->total); ?></td>
            </tr>
        </table>
        ...
        <table class="table-no-border">
            <tr>
                ...
                <img style="height: 100px; width:auto; object-fit:contain;"
                    src="<?php echo e(public_path('static/images/logo/aris_sign.png')); ?>"
                    alt=""
                />
                ...
                <img style="height: 100px; width:auto; object-fit:contain;"
                    src="<?php echo e(public_path('static/images/logo/rachman_sign.png')); ?>"
                    alt=""
                />
                ...
                <td style="align-items: center; text-align:center" >
                    ...
                    <img style="height: 100px; width:auto; object-fit:contain;"
                        src="<?php echo e(public_path('static/images/logo/tantry_sign.png')); ?>"
                        alt=""
                    />
...
<?php /**PATH C:\Users\Unknown\OneDrive\Documents\KERJA\FREELANCE\sph\resources\views/pdftemplate/potransport.blade.php ENDPATH**/ ?>