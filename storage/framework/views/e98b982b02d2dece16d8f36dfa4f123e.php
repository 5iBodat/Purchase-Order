			...
			columns: [
				...
				//{ data: "sph_code", name: "sph_code" },
				{
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            return `<a href="#" class="open-upload-modal" data-id="${row.id}">${data}</a>`;
                        }
                        return data;
                    }
                },
...
<?php /**PATH /Users/nugihiday/Documents/Workspace/sph/resources/views/sph copy/script.blade.php ENDPATH**/ ?>