<script>
	$(function () {
		const table = $("#table").DataTable({
			processing: true,
			serverSide: true,
			ajax: "<?php echo e(route('api.v1.datatables.purchase-order.index')); ?>",
			columns: [
            							...
            							const baseUrl = '/storage'; // Replace this with your storage base URL
    									   ...
    									   fullFilePath = fullFilePath.replace("/public", "");
													...
													if (row.po_status == 1){
														...
														return `<a href="${fullFilePath}" download><span class="badge bg-success"><i class="bi bi-cloud-arrow-down-fill"></i>&nbsp;&nbsp;Download PO
														</span>
														</a>`;
...
<?php /**PATH /Users/nugihiday/Documents/Workspace/sph/resources/views/purchase_order/script.blade.php ENDPATH**/ ?>