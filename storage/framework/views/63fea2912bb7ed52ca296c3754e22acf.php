<script>
	$(function () {
		...
		function totalData(){
			$.ajax({
				url: "<?php echo e(route('api.v1.datatables.sph.get-total')); ?>",
				method: 'POST',
		...
		$("#table").on("click", ".download", function(e) {
			e.preventDefault();
			const id = $(this).data("id");
			const url = "<?php echo e(route('api.v1.datatables.sph.download')); ?>";
			$.ajax({
				url:url,
				method: "POST",
				data: {id:id},
...
<?php /**PATH C:\Users\Unknown\OneDrive\Documents\KERJA\FREELANCE\sph\resources\views/sph/script.blade.php ENDPATH**/ ?>