<script>
	$(function () {
		...
		$("#table").on("click", ".download_po", function(e) {
            ...
            console.log(e);
			const id = $(this).data("id");
			const url = "<?php echo e(route('api.v1.datatables.purchase-order.download')); ?>";
			$.ajax({
				url:url,
				method: "POST",
				data: {id:id},
...
<?php /**PATH C:\Users\Unknown\OneDrive\Documents\KERJA\FREELANCE\sph\resources\views/purchase_order/script.blade.php ENDPATH**/ ?>