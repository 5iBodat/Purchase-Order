    ...
    <table>
        <tr>
            <td style="width: 10%; border:none">
                <img src="<?php echo e(public_path('static/images/logo/logo.png')); ?>" alt="Pertamina Logo" class="logo-1">
            </td>
            ...
            <?php if($sph->sph_type == "MMTEI"): ?> 
            <td style="width: 10%; border:none">
                <img src="<?php echo e(public_path('static/images/logo/pertamina.png')); ?>" alt="Pertamina Logo" class="logo-2">
            </td>
            <?php endif; ?>
        </tr>
    </table>
<hr>
    <table>
        <tr class="red-bg">
            <td style="border:none;">Ref : <?php echo e($noRef); ?></td>
            <td style="border:none;" align="right">Jakarta, <?php echo e($date["month"].'/'.$date["year"]); ?></td>
        </tr>
    </table>

    <div>
        <p>Kepada,</p>
        <p><?php echo e($sph->company_name); ?></p>
        <p>ditempat</p>
    </div>
    ...
    <tr>
        ...
        <td style="border: none;"><?php echo e($sph->product_name); ?></td>
    </tr>
            <tr>
            ...
            <tr class="red-bg">
                ...
                <td>Rp. <?php echo e($sph->harga); ?> /ltr (Harga Dasar)</td>
            </tr>
            <tr class="red-bg">
                <td style="border: none;"></td>
                <td>Rp. <?php echo e($sph->ppn); ?> /ltr (PPN 11%)</td>
            </tr>
            <tr class="red-bg">
                <td style="border: none;"></td>
                <td>Rp. <?php echo e($sph->pbbkb); ?> /ltr (PBBKB 7,5%)</td>
            </tr>
            <tr class="red-bg">
                <td style="border: none;"></td>
                <td>Rp. <?php echo e($sph->total); ?> /ltr (Total Harga Produk)</td>
            </tr>
        </table>
        <table style="width: 60%">
            ...
            <tr>
                <td style="border: none"></td>
                <td><?php echo e($sph->oatlokasi); ?></td>
                <td>Rp. <?php echo e($sph->hargaoat); ?> /Ltr</td>
            </tr>
        </table>
            ...
            <table style="border: none; margin:0; padding:0">
                <tr>
                    <td style="border: none" align="right">
                        <img src="<?php echo e(public_path('static/images/logo/footer_logo.png')); ?>" alt="">
                    </td>
                    <td style="border: none">
...
<?php /**PATH C:\Users\Unknown\OneDrive\Documents\KERJA\FREELANCE\sph\resources\views/pdftemplate/penawaran.blade.php ENDPATH**/ ?>