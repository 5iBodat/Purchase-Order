						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group has-icon-left">
									<label for="code_cust">Code Customer<span class="text-danger">(*required)</span></label>
									<div class="position-relative">
										<input type="text" class="form-control" id="code_cust"
							...
							<div class="col-lg-6">
								<div class="form-group has-icon-left">
									<label for="customer_name">Nama Customer:<span class="text-danger">(*required)</span></label>
									<div class="position-relative">
							...
							<div class="col-lg-6">
								<div class="form-group has-icon-left">
									<label for="alamat">Alamat Customer:<span class="text-danger">(*required)</span></label>
									<div class="position-relative">
