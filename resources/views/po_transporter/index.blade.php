...
@section('title', 'Pembuatan PO /  Purchase Order')
...
@include('po_transporter.modal.create')
@include('po_transporter.modal.show')
@include('po_transporter.modal.edit')
@pushOnce('scripts')
@include('po_transporter.script')
@endPushOnce
